...
## 🎉 Roo Code 3.14 został wydany

Roo Code 3.14 wprowadza nowe funkcje i usprawnienia na podstawie opinii użytkowników!

- **Pamięć podręczna dla promptów** - `gemini-2.5-pro-preview-03-25` teraz obsługuje pamięć podręczną promptów w dostawcy Gemini (Vertex i OpenRouter wkrótce).
- **Ulepszone narzędzia edycji** - Narzędzia `search_and_replace` i `insert_content` zostały ulepszone i nie są już eksperymentalne.
- **Mnóstwo innych ulepszeń** - Liczne poprawki i usprawnienia w całym rozszerzeniu.
