...
Roo Code 3.14 porta nuove funzionalità e miglioramenti basati sui tuoi feedback!

- **Cache per i prompt** - `gemini-2.5-pro-preview-03-25` ora supporta la cache dei prompt nel provider Gemini (Vertex e OpenRouter presto disponibili).
- **Strumenti di modifica migliorati** - Gli strumenti `search_and_replace` e `insert_content` sono stati migliorati e non sono più sperimentali.
- **Tantissimi altri miglioramenti** - Numerose correzioni e ottimizzazioni in tutta l'estensione.
