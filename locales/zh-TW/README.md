...
Roo Code 3.14 根據您的回饋帶來新功能和改進！

- **提示詞快取** - `gemini-2.5-pro-preview-03-25` 現已在 Gemini 提供者中支援提示詞快取（Vertex 和 OpenRouter 即將推出）。
- **編輯工具增強** - `search_and_replace` 和 `insert_content` 工具已獲改進，並從實驗階段升級為正式功能。
- **大量其他改進** - 擴充套件中的眾多修復和增強功能。
