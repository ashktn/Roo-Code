...
## 🎉 Roo Code 3.14 Yayınlandı

Roo Code 3.14 geri bildirimlerinize dayanarak yeni özellikler ve iyileştirmeler getiriyor!

- **Prompt Önbelleği** - `gemini-2.5-pro-preview-03-25` artık Gemini sağlayıcısında prompt önbelleklemeyi destekliyor (Vertex ve OpenRouter yakında geliyor).
- **Geliştirilmiş Düzenleme Araçları** - `search_and_replace` ve `insert_content` araçları iyileştirildi ve deneysel statüsünden çıkarıldı.
- **Çok Sayıda Diğer İyileştirme** - Eklenti genelinde sayısız düzeltme ve geliştirme.
