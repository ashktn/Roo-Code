...
## 🎉 Roo Code 3.14 Lanzado

¡Roo Code 3.14 trae nuevas funcionalidades y mejoras basadas en tus comentarios!

- **Caché para prompts** - `gemini-2.5-pro-preview-03-25` ahora admite caché de prompts en el proveedor Gemini (Vertex y OpenRouter próximamente).
- **Herramientas de edición mejoradas** - Las herramientas `search_and_replace` y `insert_content` han sido mejoradas y ya no son experimentales.
- **Montones de otras mejoras** - Numerosas correcciones y mejoras en toda la extensión.
