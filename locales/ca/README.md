...
## 🎉 Roo Code 3.14 Llançat

Roo Code 3.14 aporta noves funcionalitats i millores basades en els vostres comentaris!

- **Memòria cau per a prompts** - `gemini-2.5-pro-preview-03-25` ara suporta memòria cau de prompts al proveïdor Gemini (Vertex i OpenRouter disponibles aviat).
- **Eines d'edició millorades** - Les eines `search_and_replace` i `insert_content` han estat millorades i ja no són experimentals.
- **Moltes altres millores** - Nombroses correccions i optimitzacions a tota l'extensió.
